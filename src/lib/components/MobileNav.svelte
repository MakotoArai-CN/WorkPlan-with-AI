...
<nav class="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-slate-200 flex justify-around items-center z-40 safe-nav">
    <button on:click={() => switchView('dashboard')} class="flex-1 flex flex-col items-center justify-center h-full gap-0.5 py-2"
    ...
    <button on:click={() => switchView('templates')} class="flex-1 flex flex-col items-center justify-center h-full gap-0.5 py-2"
    ...
    <button on:click={() => switchView('scheduled')} class="flex-1 flex flex-col items-center justify-center h-full gap-0.5 py-2"
    ...
    <button on:click={() => switchView('aichat')} class="flex-1 flex flex-col items-center justify-center h-full gap-0.5 py-2"
        class:text-indigo-600={$currentView === 'aichat'}
        class:text-slate-400={$currentView !== 'aichat'}>
        <i class="ph ph-robot text-2xl"></i>
        <span class="text-[10px] font-semibold">AI</span>
    </button>

    <button on:click={() => switchView('settings')} class="flex-1 flex flex-col items-center justify-center h-full gap-0.5 py-2"
