...
<div
    class="flex flex-col bg-gradient-to-b from-slate-50 to-white h-screen md:h-full overflow-hidden"
>
    <header
    ...
    >
        <div class="flex items-center gap-2 md:gap-3">
            ...
            <div
                class="w-8 h-8 md:w-10 md:h-10 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-xl flex items-center justify-center text-white shadow-lg"
            >
            ...
            {#each $aiChatHistory as msg, index}
                ...
                >
                    ...
                    {:else}
                        ...
                        >
                            <i class="ph-fill ph-robot text-sm md:text-base"
                            ></i>
                        </div>
                    {/if}
    ...
    >
        ...
        >
            ...
            >
                <i class="ph-bold ph-paper-plane-right text-base md:text-lg"
                ></i>
            </button>
        </div>
