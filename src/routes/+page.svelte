...
<div class="h-screen flex flex-col md:flex-row overflow-hidden text-slate-800">
    {#if !$taskStore.accessKey}
        <LoginModal />
    {:else}
        <Sidebar />
        ...
        {#if $showAiPanel}
            <div class="md:hidden fixed inset-0 z-50 bg-white flex flex-col">
                <div class="h-14 border-b border-rose-100 flex items-center justify-between px-4 bg-white shrink-0">
